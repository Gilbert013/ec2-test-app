package com.example.ec2_test_app.controller;

import com.example.ec2_test_app.domain.Board;
import com.example.ec2_test_app.service.BoardService;
...
public class HomeController {
    ...
    public String home(Model model){
        ...
        model.addAttribute("serverInfo", System.getProperty("os.name")
